...
If you want to extend Paperclip today, the best path is often the [plugin system](docs/plugins/PLUGIN_SPEC.md). Community reference implementations are also useful feedback even when they are not merged directly into core.
