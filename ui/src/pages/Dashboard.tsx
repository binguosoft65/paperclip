    ...
    if (companies.length === 0) {
      return (
        <EmptyState
          ...
          message={t("dashboard.welcomeEmptyState")}
          action={t("dashboard.welcomeAction")}
          onAction={openOnboarding}
        />
      );
    }
    return (
      <EmptyState icon={LayoutDashboard} message={t("dashboard.selectCompanyEmptyState")} />
    );
  }
        ...
        <>
              ...
              <div className="flex items-start gap-2.5">
                ...
                <div>
                  <p className="text-sm font-medium text-red-50">
                    {t("dashboard.budgetIncident", { count: data.budgets.activeIncidents })}
                  </p>
                  <p className="text-xs text-red-100/70">
                    {t("dashboard.budgetIncidentDesc", {
          ...
          <div className="grid grid-cols-2 xl:grid-cols-4 gap-1 sm:gap-2">
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.runningCount", { count: data.agents.running })}{", "}
                  {t("dashboard.pausedCount", { count: data.agents.paused })}{", "}
                  {t("dashboard.errorsCount", { count: data.agents.error })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {t("dashboard.openCount", { count: data.tasks.open })}{", "}
                  {t("dashboard.blockedCount", { count: data.tasks.blocked })}
                </span>
              }
            />
            <MetricCard
              ...
              description={
                <span>
                  {data.costs.monthBudgetCents > 0
                    ? t("dashboard.budgetUtilization", { percent: data.costs.monthUtilizationPercent, budget: formatCents(data.costs.monthBudgetCents) })
              ...
              description={
                <span>
                  {data.budgets.pendingApprovals > 0
                    ? t("dashboard.budgetOverridesReview", { count: data.budgets.pendingApprovals })
