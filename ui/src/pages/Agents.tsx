...
export function Agents() {
  ...
  useEffect(() => {
    setBreadcrumbs([{ label: t("agents.breadcrumb") }]);
  }, [setBreadcrumbs]);

  if (!selectedCompanyId) {
    return <EmptyState icon={Bot} message={t("agents.selectCompanyEmpty")} />;
  }
  ...
  return (
    <div className="space-y-4">
      ...
      {agents && agents.length === 0 && (
        <EmptyState
          icon={Bot}
          message={t("agents.firstAgentEmpty")}
          action={t("agents.firstAgentAction")}
