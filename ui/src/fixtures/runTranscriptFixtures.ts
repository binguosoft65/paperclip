...
export const runTranscriptFixtureEntries: TranscriptEntry[] = [
  ...
  },
  {
    ...
    toolUseId: "item_1",
    input: {
      command: "sed -n '1,220p' docs/GOAL.md",
  ...
  },
  {
    ...
    toolUseId: "item_2",
    input: {
      command: "sed -n '1,320p' docs/SPEC-implementation.md",
      cwd: "/workspace/paperclip",
    },
  },
  {
