...
import { KnowledgeDrafts } from "./pages/KnowledgeDrafts";
...
function boardRoutes() {
  return (
    <>
      ...
      <Route path="knowledge" element={<Navigate to="/knowledge/drafts/pending" replace />} />
      <Route path="knowledge/drafts" element={<Navigate to="/knowledge/drafts/pending" replace />} />
      <Route path="knowledge/drafts/:status" element={<KnowledgeDrafts />} />
...
function OnboardingRoutePage() {
  ...
  const title = matchedCompany
    ? t("onboarding.addAnotherAgent", { name: matchedCompany.name })
    : companies.length > 0
      ? t("onboarding.createAnotherCompany")
      : t("onboarding.createFirstCompany");
  const description = matchedCompany
    ? t("onboarding.addAgentAndTask")
    : companies.length > 0
      ? t("onboarding.createCompanyAndAgent")
...
function NoCompaniesStartPage() {
  ...
  return (
    <div className="mx-auto max-w-xl py-10">
      <div className="rounded-lg border border-border bg-card p-6">
        <h1 className="text-xl font-semibold">{t("app.createFirstCompany")}</h1>
    ...
    <>
      <Routes>
        ...
        <Route element={<CloudAccessGate />}>
          ...
          <Route path="knowledge/drafts" element={<UnprefixedBoardRedirect />} />
          <Route path="knowledge/drafts/:status" element={<UnprefixedBoardRedirect />} />
