...
- Boundary scenarios for contributors (`AGENTS.md` §13) and communication style for AI contributors (`AGENTS.md` §14)
...
### Plan & spec file location

Plan files generated by `writing-plans` / `planning-with-files` / any superpowers-style skill **must** land in `docs/plans/` (and design specs in `docs/specs/`), per AGENTS.md §5. Do **not** create `docs/superpowers/plans/` or any other parallel tree — that path has been retired and the directory removed. Use `YYYY-MM-DD-slug.md` filenames.
